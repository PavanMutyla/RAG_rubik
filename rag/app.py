...
from chat_agent.agent_chat import agent_executor
    ...
    if not user_data_file or not allocations_file:
        ...
        try:
            ...
            if window_gpt > GPT_LIMIT or window_gemini > GEMINI_LIMIT:
                ...
                st.session_state.chat_history.append(("user", last_user_message))
                save_message("user", last_user_message)
...
from chat_agent.agent_chat import agent_executor
from rag.simple_rag import graph
